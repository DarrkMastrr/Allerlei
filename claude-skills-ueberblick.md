...
### Konkreter Malware-Beleg für die Marktplatz-Warnung (ClawHub)

Was bis hierhin eine eher allgemeine Warnung war, ist durch [video-summary-Lu95f1ZBIos.md](video-summaries/video-summary-Lu95f1ZBIos.md) mit einem harten, unabhängig verifizierten Einzelfall unterlegt: Auf ClawHub wurde der meistheruntergeladene Skill dort — ein "What Would Elon Do?"-Imitator — mit versteckter Datenexfiltration als Malware identifiziert. Per WebSearch bestätigt (The Hacker News, Unit42/Palo Alto, PointGuard AI): 230-341 schädliche Skills seit Ende Januar 2026 auf ClawHub gefunden. Zusätzlich fand eine Snyk-Studie ("ToxicSkills") Prompt-Injections in 36% der geprüften Skills auf ClawHub/skills.sh, wobei Trail-of-Bits-Forscher demnach alle öffentlichen Skill-Scanner umgehen konnten. Praktische Konsequenz für eine Team-Policy: Skills nur aus der offiziellen Anthropic-Quelle beziehen, nie ungeprüft von Community-Marktplätzen — auch nicht von seriös wirkenden Anbietern wie skills.sh (Vercel-Hintergrund schützt laut Studie nicht vor Prompt-Injection-Skills).
